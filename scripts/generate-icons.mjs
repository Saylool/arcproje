...
import { BRAND_COLOR, markSvg } from "../src/lib/brand/mark.ts";
...
async function png(size, path) {
  const svg = markSvg({ size, background: BRAND_COLOR });
...
writeFileSync("src/app/icon.svg", markSvg({ size: 512, background: BRAND_COLOR }) + "\n");
