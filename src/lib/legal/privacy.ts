      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [
              ...
              `Kod ${ACCESS_MINUTES} dakika, oturum ${SESSION_MINUTES} dakika; süresi dolunca otomatik SİLİNİR`,
            ],
            [
      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [
              ...
              `Code ${ACCESS_MINUTES} minutes, session ${SESSION_MINUTES} minutes; DELETED automatically once expired`,
            ],
            [
